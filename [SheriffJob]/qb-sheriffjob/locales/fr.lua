local Translations = {
    error = {
        ...
        on_duty_sheriff_only = 'Reservé aux policiers en service.',
    ...
    menu = {
        garage_title = 'Véhicule de sheriff',
        close = '⬅ Fermer le menu',
        impound = 'Fourrière',
        pol_impound = 'Fourrière de sheriff',
        pol_garage = 'Garage de sheriff',
        pol_armory = 'Armurerie',
    },
    email = {
        sender = 'Agence Centrale de Collection Judiciare',
        subject = 'Collection de dette',
        message = 'Cher(e) %{value}. %{value2}, <br /><br />L\'Agence Centrale de Collection judiciaire (ACCJ) a facturé les amendes que vous avez reçu de la sheriff.<br />Il y à <strong>$%{value3}</strong> qui ont été retiré de votre compte.<br /><br />Cordialement,<br />Mr. I.K. Graai',
    },
    commands = {
        place_spike = 'Poser une herse (sheriff Only)',
        license_grant = 'Donner un Permis a quelqu\'un',
        license_revoke = 'Révoqué un Permis',
        place_object = 'Placer/Supprimer un objet (sheriff Only)',
        cuff_player = 'Menotter un joueur (sheriff Only)',
        escort = 'Escorter un joueur',
        callsign = 'Donner vous un matricule',
        clear_casign = 'Nettoyer les douilles de la zone (sheriff Only)',
        jail_player = 'Mettre un joueur un prison (sheriff Only)',
        unjail_player = 'Sortir un joueur de prison (sheriff Only)',
        clearblood = 'Nettoie la zone du sang (sheriff Only)',
        seizecash = 'Saisir du Cash (sheriff Only)',
        softcuff = 'Menotter calmement (sheriff Only)',
        camera = 'Voir les caméras de sécurité (sheriff Only)',
        flagplate = 'Signaler une plaque (sheriff Only)',
        unflagplate = 'Retirer un signalement de plaque (sheriff Only)',
        plateinfo = 'Verifier une plaque (sheriff Only)',
        depot = 'Mettre en fourrière avec un prix (sheriff Only)',
        impound = 'Mettre en fourrière (sheriff Only)',
        paytow = 'Payer le dépanneur (sheriff Only)',
        paylawyer = 'Payer l\'avocat (sheriff, Judge Only)',
        anklet = 'Attacher un bracelet éléctronique (sheriff Only)',
        ankletlocation = 'Recevoir la position d\'un bracelet éléctronique',
        removeanklet = 'Retirer un bracelet éléctronique (sheriff Only)',
        drivinglicense = 'Saisir le permis de conduire (sheriff Only)',
        takedna = 'Prendre un échantillon ADN de quelqu\'un (Sac de preuve vide requis) (sheriff Only)',
        sheriff_report = 'Rapport de sheriff',
